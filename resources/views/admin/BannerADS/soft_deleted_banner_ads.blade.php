...
@section('admin_content')
        ...
        <div class="card">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    <div class="card-title col-sm-9">Bảng Danh Sách Banner ADS</div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input id="search" type="text" class="form-control" name="search"
                                placeholder="Tìm Kiếm ID Hoặc Tên Banner ADS">
                ...
                <table style="margin-top:20px " class="table table-bordered">
                    ...
                    <tbody id="loading-table-banner-ads">
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                url: '{{ url('admin/bannerads/load-deleted-banner-ads?page=') }}' + page,
                method: 'get',
                data: {

                },
                success: function(data) {
                    $('#loading-table-banner-ads').html(data);
                },
                error: function() {
                    alert("Bug Huhu :<<");
                }
    ...
    <script>
        $('#search').keyup(function() {
            ...
            $.ajax({
                url: '{{ url('admin/bannerads/search-bin') }}',
                method: 'GET',
                data: {
        ...
        $(document).on("click", ".btn-restore-item", function() {
            ...
            message_toastr("success", 'Xác Khôi Phục Banner ADS ID ' + item_id +
        ...
        function restore_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/bannerads/restore-banner-ads') }}',
                method: 'POST',
                data: {
                ...
                success: function(data) {
                    ...
                    message_toastr("success", "Banner ADS Có ID " + item_id + " Đã Được Khôi Phục!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
        ...
        $(document).on("click", ".btn-delete-item", function() {
            var item_id = $(this).data('item_id');
            message_toastr("success", 'Xác Xóa Vĩnh Viễn Banner ADS ID ' + item_id +
        ...
        function delete_trash_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/bannerads/delete-trash-banner-ads') }}',
                method: 'POST',
                data: {
                    bannerads_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Banner ADS Có ID " + item_id + " Đã Được Xóa Vĩnh Viển!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
