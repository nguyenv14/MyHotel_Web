...
@section('admin_content')
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table style="margin-top:20px " class="table table-bordered">
                    ...
                    <tbody id="loading-table-evaluate">
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                url: '{{ url('admin/evaluate/load-deleted-evaluate?page=') }}' + page,
                method: 'get',
                data: {

                },
                success: function(data) {
                    $('#loading-table-evaluate').html(data);
                },
                error: function() {
                    alert("Bug Huhu :<<");
                }
    ...
    <script>
        $('#search').keyup(function() {
            ...
            $.ajax({
                url: '{{ url('admin/evaluate/search-bin') }}',
                method: 'GET',
                data: {
        ...
        function restore_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/evaluate/restore-evaluate') }}',
                method: 'POST',
                data: {
                    evaluate_id: item_id,
                },
        ...
        function delete_trash_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/evaluate/delete-trash-evaluate') }}',
                method: 'POST',
                data: {
                    evaluate_id: item_id,
                },
