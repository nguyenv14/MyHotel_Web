...
@section('admin_content')
        ...
        <div class="card">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    <div class="card-title col-sm-9">Bảng Danh Sách Đơn Phòng</div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input id="search" type="text" class="form-control" name="search"
                                placeholder="Tìm Kiếm ID Hoặc Tên Đơn Phòng">
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                url: '{{ url('admin/order/load-deleted-order?page=') }}' + page,
                method: 'get',
                data: {

                },
                success: function(data) {
                    $('#loading-table-order').html(data);
                },
                error: function() {
                    alert("Bug Huhu :<<");
                }
    ...
    <script>
        $('#search').keyup(function() {
            ...
            $.ajax({
                url: '{{ url('admin/order/search-bin') }}',
                method: 'GET',
                data: {
        ...
        $(document).on("click", ".btn-restore-item", function() {
            ...
            message_toastr("success", 'Xác Khôi Phục Đơn Phòng ID ' + item_id +
        ...
        function restore_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/order/restore-order') }}',
                method: 'POST',
                data: {
                   order_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Đơn Phòng Có ID " + item_id + " Đã Được Khôi Phục!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
        ...
        $(document).on("click", ".btn-delete-item", function() {
            var item_id = $(this).data('item_id');
            message_toastr("success", 'Xác Xóa Vĩnh Viễn Đơn Phòng ID ' + item_id +
        ...
        function delete_trash_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/order/delete-trash-order') }}',
                method: 'POST',
                data: {
                   order_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Đơn Phòng Có ID " + item_id + " Đã Được Xóa Vĩnh Viển!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
