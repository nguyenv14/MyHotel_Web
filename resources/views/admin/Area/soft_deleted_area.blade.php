...
@section('admin_content')
        ...
        <div class="card">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    <div class="card-title col-sm-9">Bảng Danh Sách Khu Vực</div>
                    <div class="col-sm-3">
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                url: '{{ url('/admin/area/load-deleted-area?page=') }}' + page,
                method: 'get',
                data: {

                },
                success: function(data) {
                    $('#loading-table-area').html(data);
                },
                error: function() {
                    alert("Bug Huhu :<<");
                }
    ...
    <script>
        ...
        $(document).on("click", ".btn-restore-item", function() {
            ...
            message_toastr("success", 'Xác Khôi Phục Khu Vực ID ' + item_id +
        ...
        function restore_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('/admin/area/restore-area') }}',
                method: 'POST',
                data: {
                    area_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Khu Vực Có ID " + item_id + " Đã Được Khôi Phục!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
        ...
        $(document).on("click", ".btn-delete-item", function() {
            var item_id = $(this).data('item_id');
            message_toastr("success", 'Xác Xóa Vĩnh Viễn Khu Vực ID ' + item_id +
        ...
        function delete_trash_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('/admin/area/delete-trash-area') }}',
                method: 'POST',
                data: {
                    area_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Khu Vực Có ID " + item_id + " Đã Được Xóa Vĩnh Viển!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
