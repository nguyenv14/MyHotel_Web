...
@section('admin_content')
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                url: '{{ url('/admin/brand/load-deleted-brand?page=') }}' + page,
                method: 'get',
                data: {

                },
                success: function(data) {
                    $('#loading-table-brand').html(data);
                },
                error: function() {
                    alert("Bug Huhu :<<");
                }
    ...
    <script>
        $('#search').keyup(function() {
            ...
            $.ajax({
                url: '{{ url('/admin/brand/search-bin') }}',
                method: 'GET',
                data: {
        ...
        $(document).on("click", ".btn-restore-item", function() {
            ...
            message_toastr("success", 'Xác Khôi Phục Thương Hiệu ID ' + item_id +
        ...
        function restore_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('/admin/brand/restore-brand') }}',
                method: 'POST',
                data: {
                    brand_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Thương Hiệu Có ID " + item_id + " Đã Được Khôi Phục!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
        ...
        $(document).on("click", ".btn-delete-item", function() {
            var item_id = $(this).data('item_id');
            message_toastr("success", 'Xác Xóa Vĩnh Viễn Thương Hiệu ID ' + item_id +
        ...
        function delete_trash_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('/admin/brand/delete-trash-brand') }}',
                method: 'POST',
                data: {
                    brand_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Thương Hiệu Có ID " + item_id + " Đã Được Xóa Vĩnh Viển!");
                    getPosts(notePage);
                },
                error: function() {
                    $(".loading").css({
